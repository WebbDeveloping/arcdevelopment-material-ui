...
import integrationAnimation from '../animations/integraationAnimation/data.json';
    ...
    <Grid container direction='column'>
      ...
      >
        <Grid item container direction='column' md>
          ...
          <Grid item>
            ...
            <Typography align={matchesSM ? 'center' : undefined} variant='body1' paragraph>
              Rhis Allows you to extend your reach, reinvent interactions, and
              develop a stronger realtionship with your users than ever before.
            </Typography>
          </Grid>
        </Grid>
        <Grid item md>
      ...
      >
        <Grid item container md direction='column' alignItems='center'>
          <Grid item>
            <Typography align='center' cariant='h4' gutterBottom>
        ...
        <Grid item container md direction='column' alignItems='center'>
          ...
          <Grid item>
            <img src={engagement} alt='aapp with notification' />
          </Grid>
        </Grid>
      </Grid>
      <Grid item>
